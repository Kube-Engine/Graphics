...
struct kF::Graphics::ColorBlendAttachment : public VkPipelineColorBlendAttachmentState
{
    /** @brief Initialize constructor */
    ColorBlendAttachment(const bool blendEnable_ = false,
            const BlendFactor srcColorBlendFactor_ = BlendFactor::One, const BlendFactor dstColorBlendFactor_ = BlendFactor::Zero, const BlendOp colorBlendOp_ = BlendOp::Add,
            const BlendFactor srcAlphaBlendFactor_ = BlendFactor::One, const BlendFactor dstAlphaBlendFactor_ = BlendFactor::Zero, const BlendOp alphaBlendOp_ = BlendOp::Add,
            const ColorComponentFlags colorWriteMask_ = ColorComponentFlags::RGBA)
        noexcept
